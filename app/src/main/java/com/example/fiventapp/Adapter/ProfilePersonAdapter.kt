...
class ProfilePersonAdapter : RecyclerView.Adapter<ProfilePersonAdapter.ProfilePersonViewHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfilePersonViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_event, parent, false)
        val bukuViewHolder = ProfilePersonViewHolder(view)
    ...
    override fun onBindViewHolder(holder: ProfilePersonViewHolder, position: Int) {
    ...
    inner class ProfilePersonViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var ll: CardView
